...
# Connecting the main routers
app.include_router(router_auth)
app.include_router(router_users)
app.include_router(router_hotels)
app.include_router(router_bookings)

# Connecting the additional routers
...
if settings.MODE == "TEST":
    # When testing with pytest, you need to include Redis for caching to work.
    # Otherwise, the @cache decorator from the fastapi-cache library breaks the execution of cached endpoints.
...
# Connecting an endpoint to display metrics for their further collection by Prometheus
...
async def add_process_time_header(request: Request, call_next):
    ...
    # When connecting Prometheus + Grafana, such a log is not required
